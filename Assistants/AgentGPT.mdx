...
## Steps to Configure AgentGPT
### PreRequisites
1. AgentGPT assistant should be configured. TO know more about the process of AgentGPT Assistant [click here](../Introduction/getting-started.mdx).

## AgentGPT Configuration Attributes
